# This is a slightly-modified version of rest-open-uri. It fixes two
# issues:
#   - Redirects following a request with a method other than GET now
#     work. Previously redirects were using the same method as the
#     original request.
#   - It is now possible to specify the content-type.
#
# Additionally, the namespace has changed.
